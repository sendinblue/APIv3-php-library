...
class ProcessApi
{
    ...
    public function getProcessWithHttpInfo($process_id)
    {
        ...
        $request = $this->getProcessRequest($process_id);
     ...
     */
    public function getProcessAsync($process_id)
    {
        return $this->getProcessAsyncWithHttpInfo($process_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getProcessAsyncWithHttpInfo($process_id)
    {
        $returnType = '\SendinBlue\Client\Model\GetProcess';
        $request = $this->getProcessRequest($process_id);
     ...
     */
    protected function getProcessRequest($process_id)
    {
