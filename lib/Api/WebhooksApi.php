...
class WebhooksApi
{
     ...
     * Create a webhook
     *
     * @param  \SendinBlue\Client\Model\CreateWebhook $create_webhook Values to create a webhook (required)
     *
    ...
    public function createWebhookWithHttpInfo($create_webhook)
    {
        ...
        $request = $this->createWebhookRequest($create_webhook);
     ...
     */
    public function createWebhookAsync($create_webhook)
    {
        return $this->createWebhookAsyncWithHttpInfo($create_webhook)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createWebhookAsyncWithHttpInfo($create_webhook)
    {
        $returnType = '\SendinBlue\Client\Model\CreateModel';
        $request = $this->createWebhookRequest($create_webhook);
     ...
     */
    protected function createWebhookRequest($create_webhook)
    {
     ...
     *
     * @param  int $webhook_id Id of the webhook (required)
     * @param  \SendinBlue\Client\Model\UpdateWebhook $update_webhook Values to update a webhook (required)
     *
     * @throws \SendinBlue\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
    ...
    {
        $this->updateWebhookWithHttpInfo($webhook_id, $update_webhook);
    }
    ...
    {
        $returnType = '';
        $request = $this->updateWebhookRequest($webhook_id, $update_webhook);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateWebhookAsync($webhook_id, $update_webhook)
    {
        return $this->updateWebhookAsyncWithHttpInfo($webhook_id, $update_webhook)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateWebhookAsyncWithHttpInfo($webhook_id, $update_webhook)
    {
        $returnType = '';
        $request = $this->updateWebhookRequest($webhook_id, $update_webhook);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function updateWebhookRequest($webhook_id, $update_webhook)
    {
        // verify the required parameter 'webhook_id' is set
        if ($webhook_id === null || (is_array($webhook_id) && count($webhook_id) === 0)) {
            throw new \InvalidArgumentException(
