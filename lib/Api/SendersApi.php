...
class SendersApi
{
    ...
    {
        $this->deleteSenderWithHttpInfo($sender_id);
    }
    ...
    public function getIpsFromSenderWithHttpInfo($sender_id)
    {
        ...
        $request = $this->getIpsFromSenderRequest($sender_id);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getIpsFromSenderAsync($sender_id)
    {
        return $this->getIpsFromSenderAsyncWithHttpInfo($sender_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getIpsFromSenderAsyncWithHttpInfo($sender_id)
    {
        $returnType = '\SendinBlue\Client\Model\GetIpsFromSender';
        $request = $this->getIpsFromSenderRequest($sender_id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getIpsFromSenderRequest($sender_id)
    {
        // verify the required parameter 'sender_id' is set
        if ($sender_id === null || (is_array($sender_id) && count($sender_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $sender_id when calling getIpsFromSender'
            );
        }
    ...
    {
        $this->updateSenderWithHttpInfo($sender_id, $sender);
    }
    ...
    {
        $returnType = '';
        $request = $this->updateSenderRequest($sender_id, $sender);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateSenderAsync($sender_id, $sender = null)
    {
        return $this->updateSenderAsyncWithHttpInfo($sender_id, $sender)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateSenderAsyncWithHttpInfo($sender_id, $sender = null)
    {
        $returnType = '';
        $request = $this->updateSenderRequest($sender_id, $sender);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function updateSenderRequest($sender_id, $sender = null)
    {
        // verify the required parameter 'sender_id' is set
        if ($sender_id === null || (is_array($sender_id) && count($sender_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $sender_id when calling updateSender'
            );
        }
