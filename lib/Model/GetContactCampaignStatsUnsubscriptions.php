...
class GetContactCampaignStatsUnsubscriptions implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'user_unsubscription' => '\SendinBlue\Client\Model\GetExtendedContactDetailsStatisticsUnsubscriptionsUserUnsubscription[]',
        'admin_unsubscription' => '\SendinBlue\Client\Model\GetExtendedContactDetailsStatisticsUnsubscriptionsAdminUnsubscription[]'
    ];
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['user_unsubscription'] === null) {
            $invalidProperties[] = "'user_unsubscription' can't be null";
        }
        if ($this->container['admin_unsubscription'] === null) {
            $invalidProperties[] = "'admin_unsubscription' can't be null";
        }
     ...
     *
     * @param \SendinBlue\Client\Model\GetExtendedContactDetailsStatisticsUnsubscriptionsUserUnsubscription[] $user_unsubscription Contact has unsubscribed via the unsubscription link in the email
     *
     * @return $this
     */
     ...
     *
     * @param \SendinBlue\Client\Model\GetExtendedContactDetailsStatisticsUnsubscriptionsAdminUnsubscription[] $admin_unsubscription Contact has been unsubscribed from the administrator
     *
     * @return $this
     */
