...
class GetEmailCampaign implements ArrayAccess
{
    ...
    public function setScheduledAt($scheduledAt)
    {
        ...
        if ((!preg_match("/YYYY-MM-DD HH:mm:ss/", $scheduledAt))) {
            throw new \InvalidArgumentException("invalid value for $scheduledAt when calling GetEmailCampaign., must conform to the pattern /YYYY-MM-DD HH:mm:ss/.");
        }
    ...
    public function setCreatedAt($createdAt)
    {
        ...
        if ((!preg_match("/YYYY-MM-DD HH:mm:ss/", $createdAt))) {
            throw new \InvalidArgumentException("invalid value for $createdAt when calling GetEmailCampaign., must conform to the pattern /YYYY-MM-DD HH:mm:ss/.");
        }
    ...
    public function setModifiedAt($modifiedAt)
    {
        ...
        if ((!preg_match("/YYYY-MM-DD HH:mm:ss/", $modifiedAt))) {
            throw new \InvalidArgumentException("invalid value for $modifiedAt when calling GetEmailCampaign., must conform to the pattern /YYYY-MM-DD HH:mm:ss/.");
        }
