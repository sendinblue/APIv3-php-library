 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class EmailCampaigns implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'emailCampaigns';
    ...
    public function setScheduledAt($scheduled_at)
    {
        ...
        if (!is_null($scheduled_at) && (!preg_match("/YYYY-MM-DD HH:mm:ss/", $scheduled_at))) {
            throw new \InvalidArgumentException("invalid value for $scheduled_at when calling EmailCampaigns., must conform to the pattern /YYYY-MM-DD HH:mm:ss/.");
        }
