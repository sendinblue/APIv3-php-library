...
class CreateEmailCampaign implements ModelInterface, ArrayAccess
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['send_at_best_time'] = isset($data['send_at_best_time']) ? $data['send_at_best_time'] : false;
    ...
    public function setSplitRule($split_rule)
    {
        ...
        if (!is_null($split_rule) && ($split_rule > 50)) {
            throw new \InvalidArgumentException('invalid value for $split_rule when calling CreateEmailCampaign., must be smaller than or equal to 50.');
        }
        if (!is_null($split_rule) && ($split_rule < 1)) {
            throw new \InvalidArgumentException('invalid value for $split_rule when calling CreateEmailCampaign., must be bigger than or equal to 1.');
        }
    ...
    public function setWinnerDelay($winner_delay)
    {
        ...
        if (!is_null($winner_delay) && ($winner_delay > 168)) {
            throw new \InvalidArgumentException('invalid value for $winner_delay when calling CreateEmailCampaign., must be smaller than or equal to 168.');
        }
        if (!is_null($winner_delay) && ($winner_delay < 1)) {
            throw new \InvalidArgumentException('invalid value for $winner_delay when calling CreateEmailCampaign., must be bigger than or equal to 1.');
        }
     ...
     * Sets initial_quota
     *
     * @param int $initial_quota Mandatory if ipWarmupEnable is set to true. Set an initial quota greater than 1 for warming up your ip. We recommend you set a value of 3000.
     *
     * @return $this
     */
     ...
     * Sets increase_rate
     *
     * @param int $increase_rate Mandatory if ipWarmupEnable is set to true. Set a percentage increase rate for warming up your ip. We recommend you set the increase rate to 30% per day. If you want to send the same number of emails every day, set the daily increase value to 0%.
     *
     * @return $this
     */
    public function setIncreaseRate($increase_rate)
    {
        ...
        if (!is_null($increase_rate) && ($increase_rate > 100)) {
            throw new \InvalidArgumentException('invalid value for $increase_rate when calling CreateEmailCampaign., must be smaller than or equal to 100.');
        }
        if (!is_null($increase_rate) && ($increase_rate < 0)) {
            throw new \InvalidArgumentException('invalid value for $increase_rate when calling CreateEmailCampaign., must be bigger than or equal to 0.');
        }
