 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class UpdateAttribute implements ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'value' => 'string',
        'enumeration' => '\SendinBlue\Client\Model\UpdateAttributeEnumeration[]'
    ];
    ...
    /**
     * Sets enumeration
     * @param \SendinBlue\Client\Model\UpdateAttributeEnumeration[] $enumeration Values that the attribute can take. Use only if the attribute's category is category
     * @return $this
     */
