...
/**
 * CreateSmsCampaign1 Class Doc Comment
 *
 * @category    Class
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class CreateSmsCampaign1 implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'createSmsCampaign_1';
    ...
    {
        if ((strlen($sender) > 11)) {
            throw new \InvalidArgumentException('invalid length for $sender when calling CreateSmsCampaign1., must be smaller than or equal to 11.');
        }
    ...
    public function setScheduledAt($scheduled_at)
    {
        ...
        if (!is_null($scheduled_at) && (!preg_match("/YYYY-MM-DD HH:mm:ss/", $scheduled_at))) {
            throw new \InvalidArgumentException("invalid value for $scheduled_at when calling CreateSmsCampaign1., must conform to the pattern /YYYY-MM-DD HH:mm:ss/.");
        }
