...
/**
 * GetSmsCampaign1 Class Doc Comment
 *
 * @category    Class
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class GetSmsCampaign1 implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'getSmsCampaign_1';
    ...
    public function setScheduledAt($scheduled_at)
    {
        ...
        if ((!preg_match("/YYYY-MM-DD HH:mm:ss/", $scheduled_at))) {
            throw new \InvalidArgumentException("invalid value for $scheduled_at when calling GetSmsCampaign1., must conform to the pattern /YYYY-MM-DD HH:mm:ss/.");
        }
    ...
    public function setCreatedAt($created_at)
    {
        ...
        if ((!preg_match("/YYYY-MM-DD HH:mm:ss/", $created_at))) {
            throw new \InvalidArgumentException("invalid value for $created_at when calling GetSmsCampaign1., must conform to the pattern /YYYY-MM-DD HH:mm:ss/.");
        }
    ...
    public function setModifiedAt($modified_at)
    {
        ...
        if ((!preg_match("/YYYY-MM-DD HH:mm:ss/", $modified_at))) {
            throw new \InvalidArgumentException("invalid value for $modified_at when calling GetSmsCampaign1., must conform to the pattern /YYYY-MM-DD HH:mm:ss/.");
        }
