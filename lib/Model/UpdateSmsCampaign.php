...
class UpdateSmsCampaign implements ModelInterface, ArrayAccess
{
     ...
     * Sets scheduled_at
     *
     * @param \DateTime $scheduled_at UTC date-time on which the campaign has to run (YYYY-MM-DDTHH:mm:ss.SSSZ). Prefer to pass your timezone in date-time format for accurate result.
     *
     * @return $this
     */
