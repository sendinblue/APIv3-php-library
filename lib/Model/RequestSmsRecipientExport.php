...
class RequestSmsRecipientExport implements ModelInterface, ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['recipients_type'] === null) {
            $invalidProperties[] = "'recipients_type' can't be null";
        }
        $allowedValues = $this->getRecipientsTypeAllowableValues();
        if (!is_null($this->container['recipients_type']) && !in_array($this->container['recipients_type'], $allowedValues, true)) {
     ...
     * Sets notify_url
     *
     * @param string $notify_url URL that will be called once the export process is finished. For reference, https://help.sendinblue.com/hc/en-us/articles/360007666479
     *
     * @return $this
     */
    ...
    {
        $allowedValues = $this->getRecipientsTypeAllowableValues();
        if (!in_array($recipients_type, $allowedValues, true)) {
