...
class UploadImageToGallery implements ModelInterface, ArrayAccess
{
     ...
     * Sets image_url
     *
     * @param string $image_url The absolute url of the image (no local file). Maximum allowed size for image is 2MB. Allowed extensions for images are - jpeg, jpg, png, bmp, gif.
     *
     * @return $this
     */
