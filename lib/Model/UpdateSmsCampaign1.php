...
/**
 * UpdateSmsCampaign1 Class Doc Comment
 *
 * @category    Class
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class UpdateSmsCampaign1 implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'updateSmsCampaign_1';
    ...
    public function setSender($sender)
    {
        if (!is_null($sender) && (strlen($sender) > 11)) {
            throw new \InvalidArgumentException('invalid length for $sender when calling UpdateSmsCampaign1., must be smaller than or equal to 11.');
        }
    ...
    public function setScheduledAt($scheduled_at)
    {
        ...
        if (!is_null($scheduled_at) && (!preg_match("/YYYY-MM-DD HH:mm:ss/", $scheduled_at))) {
            throw new \InvalidArgumentException("invalid value for $scheduled_at when calling UpdateSmsCampaign1., must conform to the pattern /YYYY-MM-DD HH:mm:ss/.");
        }
