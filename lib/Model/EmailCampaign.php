 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class EmailCampaign implements ArrayAccess
{
    ...
    public function setScheduledAt($scheduled_at)
    {
        ...
        if (!is_null($scheduled_at) && (!preg_match("/YYYY-MM-DD HH:mm:ss/", $scheduled_at))) {
            throw new \InvalidArgumentException("invalid value for $scheduled_at when calling EmailCampaign., must conform to the pattern /YYYY-MM-DD HH:mm:ss/.");
        }
