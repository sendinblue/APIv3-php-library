...
class GetSmsCampaign implements ArrayAccess
{
    ...
    public function setScheduledAt($scheduled_at)
    {
        ...
        if ((!preg_match("/YYYY-MM-DD HH:mm:ss/", $scheduled_at))) {
            throw new \InvalidArgumentException("invalid value for $scheduled_at when calling GetSmsCampaign., must conform to the pattern /YYYY-MM-DD HH:mm:ss/.");
        }
    ...
    public function setCreatedAt($created_at)
    {
        ...
        if ((!preg_match("/YYYY-MM-DD HH:mm:ss/", $created_at))) {
            throw new \InvalidArgumentException("invalid value for $created_at when calling GetSmsCampaign., must conform to the pattern /YYYY-MM-DD HH:mm:ss/.");
        }
    ...
    public function setModifiedAt($modified_at)
    {
        ...
        if ((!preg_match("/YYYY-MM-DD HH:mm:ss/", $modified_at))) {
            throw new \InvalidArgumentException("invalid value for $modified_at when calling GetSmsCampaign., must conform to the pattern /YYYY-MM-DD HH:mm:ss/.");
        }
