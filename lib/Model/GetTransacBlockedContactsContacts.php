...
class GetTransacBlockedContactsContacts implements ModelInterface, ArrayAccess
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['blocked_at'] = isset($data['blocked_at']) ? $data['blocked_at'] : null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['blocked_at'] === null) {
            $invalidProperties[] = "'blocked_at' can't be null";
        }
     ...
     * Sets blocked_at
     *
     * @param \DateTime $blocked_at Date when the contact was blocked or unsubscribed on
     *
     * @return $this
     */
