...
/**
 * InlineResponse2008Campaigns Class Doc Comment
 *
 * @category    Class
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class InlineResponse2008Campaigns implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'inline_response_200_8_campaigns';
    ...
    protected static $swaggerTypes = [
        ...
        'statistics' => '\Swagger\Client\Model\InlineResponse2008Statistics'
    ];
    ...
    public function setScheduledAt($scheduled_at)
    {
        ...
        if ((!preg_match("/YYYY-MM-DD HH:mm:ss/", $scheduled_at))) {
            throw new \InvalidArgumentException("invalid value for $scheduled_at when calling InlineResponse2008Campaigns., must conform to the pattern /YYYY-MM-DD HH:mm:ss/.");
        }
    ...
    public function setCreatedAt($created_at)
    {
        ...
        if ((!preg_match("/YYYY-MM-DD HH:mm:ss/", $created_at))) {
            throw new \InvalidArgumentException("invalid value for $created_at when calling InlineResponse2008Campaigns., must conform to the pattern /YYYY-MM-DD HH:mm:ss/.");
        }
    ...
    public function setModifiedAt($modified_at)
    {
        ...
        if ((!preg_match("/YYYY-MM-DD HH:mm:ss/", $modified_at))) {
            throw new \InvalidArgumentException("invalid value for $modified_at when calling InlineResponse2008Campaigns., must conform to the pattern /YYYY-MM-DD HH:mm:ss/.");
        }
    ...
    /**
     * Gets statistics
     * @return \Swagger\Client\Model\InlineResponse2008Statistics
     */
    ...
    /**
     * Sets statistics
     * @param \Swagger\Client\Model\InlineResponse2008Statistics $statistics
     * @return $this
     */
