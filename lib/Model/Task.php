...
class Task implements ModelInterface, ArrayAccess
{
    ...
    {
        $this->container['firstContact'] = isset($data['firstContact']) ? $data['firstContact'] : null;
    ...
    {
        return $this->container['firstContact'];
    }
    ...
    {
        $this->container['firstContact'] = $firstContact;
     ...
     * Sets createdAt
     *
     * @param \DateTime $createdAt Task created date/time
     *
     * @return $this
     */
     ...
     * Sets updatedAt
     *
     * @param \DateTime $updatedAt Task update date/time
     *
     * @return $this
     */
