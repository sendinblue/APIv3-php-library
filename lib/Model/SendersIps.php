 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class SendersIps implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'senders_ips';
    ...
    public function setWeight($weight)
    {
        ...
        if (!is_null($weight) && ($weight > 100)) {
            throw new \InvalidArgumentException('invalid value for $weight when calling SendersIps., must be smaller than or equal to 100.');
        }
        if (!is_null($weight) && ($weight < 1)) {
            throw new \InvalidArgumentException('invalid value for $weight when calling SendersIps., must be bigger than or equal to 1.');
        }
