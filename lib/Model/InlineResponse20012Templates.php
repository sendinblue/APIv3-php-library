...
/**
 * InlineResponse20012Templates Class Doc Comment
 *
 * @category    Class
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class InlineResponse20012Templates implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'inline_response_200_12_templates';
    ...
    public function setCreatedAt($created_at)
    {
        ...
        if ((!preg_match("/YYYY-MM-DD HH:mm:ss/", $created_at))) {
            throw new \InvalidArgumentException("invalid value for $created_at when calling InlineResponse20012Templates., must conform to the pattern /YYYY-MM-DD HH:mm:ss/.");
        }
    ...
    public function setModifiedAt($modified_at)
    {
        ...
        if ((!preg_match("/YYYY-MM-DD HH:mm:ss/", $modified_at))) {
            throw new \InvalidArgumentException("invalid value for $modified_at when calling InlineResponse20012Templates., must conform to the pattern /YYYY-MM-DD HH:mm:ss/.");
        }
