...
/**
 * SendTransacSms1 Class Doc Comment
 *
 * @category    Class
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class SendTransacSms1 implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'sendTransacSms_1';
    ...
    {
        if ((strlen($sender) > 11)) {
            throw new \InvalidArgumentException('invalid length for $sender when calling SendTransacSms1., must be smaller than or equal to 11.');
        }
    ...
    public function setContent($content)
    {
        if ((strlen($content) > 160)) {
            throw new \InvalidArgumentException('invalid length for $content when calling SendTransacSms1., must be smaller than or equal to 160.');
        }
