...
/**
 * InlineResponse200Plan Class Doc Comment
 *
 * @category    Class
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class InlineResponse200Plan implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'inline_response_200_plan';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['credits_type'] === null) {
            $invalid_properties[] = "'credits_type' can't be null";
        }
        $allowed_values = $this->getCreditsTypeAllowableValues();
        if (!in_array($this->container['credits_type'], $allowed_values)) {
            $invalid_properties[] = sprintf(
