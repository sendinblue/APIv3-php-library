...
class DeleteHardbounces implements ModelInterface, ArrayAccess
{
     ...
     * Sets startDate
     *
     * @param \DateTime $startDate Starting date (YYYY-MM-DD) of the time period for deletion. The hardbounces occurred after this date will be deleted. Must be less than or equal to the endDate
     *
     * @return $this
     */
     ...
     * Sets endDate
     *
     * @param \DateTime $endDate Ending date (YYYY-MM-DD) of the time period for deletion. The hardbounces until this date will be deleted. Must be greater than or equal to the startDate
     *
     * @return $this
     */
